...
[ -f "$HOME/.openclaw/logs/signal-trainer.log" ] && LOG_FILES+=("$HOME/.openclaw/logs/signal-trainer.log")[ -f "$HOME/.openclaw/logs/paper-trade-runner.log" ] && LOG_FILES+=("$HOME/.openclaw/logs/paper-trade-runner.log")[ -f "$HOME/.openclaw/logs/failsafe.log" ] && LOG_FILES+=("$HOME/.openclaw/logs/failsafe.log")
