...
Generated: 2026-03-23T13:15:02Z

## Executive Summary
- OpenClaw status: healthy-signal
- LaunchAgent footprint: 23 tracked services
...
│ Gateway service │ LaunchAgent installed · loaded · running (pid 95490)                                               │
│ Node service    │ LaunchAgent not installed                                                                          │
│ Agents          │ 2 · no bootstrap files · sessions 30 · default main active just now                                │
│ Memory          │ enabled (plugin memory-core) · unavailable                                                         │
│ Probes          │ skipped (use --deep)                                                                               │
│ Events          │ none                                                                                               │
│ Heartbeat       │ 1h (main), disabled (hal)                                                                          │
│ Sessions        │ 30 active · default claude-haiku-4-5 (200k ctx) · 2 stores                                         │
└─────────────────┴────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
│ agent:main:cron:648bc4bb-4fba-4…            │ direct │ just now │ claude-haiku-4-5 │ unknown/200k (?%)               │
│ agent:main:card:task_1774182651…            │ direct │ 1m ago   │ gpt-5.3-codex    │ unknown/272k (?%)               │
│ agent:main:main                             │ direct │ 11m ago  │ gpt-5.3-codex    │ unknown/272k (?%)               │
│ agent:main:idle:1774201758672               │ direct │ 15m ago  │ gpt-5.3-codex    │ unknown/272k (?%)               │
│ agent:main:idle:1773298848829               │ direct │ 15m ago  │ gpt-5.3-codex    │ unknown/272k (?%)               │
│ agent:main:cron:be7d983c-490b-4…            │ direct │ 1h ago   │ claude-haiku-4-5 │ 23k/200k (12%) · 🗄️ 192% cached │
│ agent:main:cron:be7d983c-490b-4…            │ direct │ 1h ago   │ claude-haiku-4-5 │ 23k/200k (12%) · 🗄️ 192% cached │
│ agent:main:cron:0a4ceaca-64d7-4…            │ direct │ 1h ago   │ claude-haiku-4-5 │ 33k/200k (17%) · 🗄️ 33% cached  │
│ agent:main:cron:0a4ceaca-64d7-4…            │ direct │ 1h ago   │ claude-haiku-4-5 │ 33k/200k (17%) · 🗄️ 33% cached  │
└─────────────────────────────────────────────┴────────┴──────────┴──────────────────┴─────────────────────────────────┘
...
Update available (npm 2026.3.22). Run: openclaw update
