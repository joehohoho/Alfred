...
Recent: [idle:workspace-check] Git clean, 16 unanswered no | [idle:workspace-check] Git clean; 8 unanswered not
Updated: 17:22 AST
...
3. If not found, check `memory/2026-04-16.md` and `ACTIVE-TASK.md`.
