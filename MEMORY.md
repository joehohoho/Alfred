...
Recent: [idle:goal-progress-check 2026-04-15 17:21] Unbloc | [idle:workspace-check] All repos clean except comm
Updated: 18:21 AST
...
3. If not found, check `memory/2026-04-15.md` and `ACTIVE-TASK.md`.
