...
Recent: [idle:goal-progress-check 2026-04-01 11:32] Review | [idle:review-memory] Completed 5-day memory review
Updated: 19:02 AST
...
3. If not found, check `memory/2026-04-01.md` and `ACTIVE-TASK.md`.
